...
export const ChatDetail: React.FC = () => {
    ...
    const handleSend = async (e?: React.FormEvent) => {
        ...
        await sendMessage(
            { id: currentUser.uid, name: currentUser.displayName!, avatar: currentUser.photoURL!, isExpert: false } as User,
            targetUser,
            content
        );
    };

    if (!currentUser || !targetUser) return <div className="p-4 text-center">Đang tải...</div>;

    return (
        <div className="flex flex-col h-screen bg-gray-50 fixed inset-0 z-50">
            {/* Header */}
            <div className="bg-white px-4 py-3 flex items-center justify-between border-b border-gray-100 shadow-sm pt-safe-top">
            ...
            {/* Input Area */}
            <div className="bg-white p-3 pb-safe-bottom border-t border-gray-100">
