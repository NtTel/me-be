                ...
                <div className="flex-1 p-4 flex flex-col items-center justify-center min-h-[400px] bg-gray-50 dark:bg-black/50 relative overflow-hidden">
                    ...
                    {!previewUrl ? (
                        <div onClick={() => fileInputRef.current?.click()} className="w-full h-full min-h-[350px] border-2 border-dashed border-gray-300 dark:border-gray-700 rounded-xl flex flex-col items-center justify-center cursor-pointer group hover:border-primary hover:bg-blue-50 dark:hover:bg-blue-900/10 transition-all gap-4 p-6">
                            ...
                            <div className="text-center"><p className="font-bold text-gray-700 dark:text-gray-200 text-lg mb-1">{t("home.uploadImageTitle")}</p><p className="text-sm text-gray-500 dark:text-gray-400">{t("home.uploadImageFormats")}</p></div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-gradient-to-br from-primary to-[#26A69A] rounded-3xl p-6 text-white shadow-xl shadow-primary/20 relative overflow-hidden mx-4 md:mx-0">
                        ...
                        <div className="relative z-10 flex justify-between items-center">
                            <div><h2 className="text-xl font-bold mb-1">{t("home.heroTitle")}</h2><p className="text-blue-50 text-xs font-medium opacity-90 mb-3">{t("home.heroSubtitle")}</p><Link to="/expert-register" className="inline-flex items-center gap-1 bg-white/20 hover:bg-white/30 backdrop-blur-md px-3 py-1.5 rounded-lg text-xs font-bold transition-all active:scale-95 border border-white/20">{t("home.heroCta")}<ChevronRight size={14} /></Link></div>
