...
export const AdminLayout: React.FC<AdminLayoutProps> = ({ currentUser, onLogout }) => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      {/* SIDEBAR */}
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-white border-r border-gray-200 transform transition-transform duration-200 ease-in-out ${isSidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0`}>
